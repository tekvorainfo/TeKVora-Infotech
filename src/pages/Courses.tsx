import { ArrowRight, Award, BookOpen, CheckCircle, ChevronRight, Clock, Cloud, Code, Database, GraduationCap, Layers, Palette, PlayCircle, Search, Server, Smartphone, Sparkles, Star, TrendingUp, Users } from 'lucide-react';
...
const staticCourses: Course[] = [
  { id: '1', title: 'Full Stack Web Development', slug: 'full-stack-web-development', description: 'Master the complete web development stack from frontend to backend. Build real-world projects using Django, React, and MySQL.', duration: '3 Months', skills: ['HTML', 'CSS', 'JavaScript', 'Django', 'MySQL', 'React'], instructor: '', type: 'Paid', certificate_eligible: true, status: 'active', created_at: '' },
  { id: '2', title: 'Python Programming', slug: 'python-programming', description: 'Learn Python from scratch to advanced level. Cover OOP, APIs, and practical applications across multiple domains.', duration: '6 Weeks', skills: ['Python', 'OOP', 'APIs', 'Data Structures'], instructor: '', type: 'Paid', certificate_eligible: true, status: 'active', created_at: '' },
  { id: '3', title: 'Data Science with Python', slug: 'data-science-with-python', description: 'Dive into data science. Analyze data, build ML models, and extract actionable insights from complex datasets.', duration: '2 Months', skills: ['Pandas', 'NumPy', 'ML Basics', 'Visualization', 'Jupyter'], instructor: '', type: 'Paid', certificate_eligible: true, status: 'active', created_at: '' },
  { id: '4', title: 'Mobile App Development', slug: 'mobile-app-development', description: 'Build cross-platform mobile applications using Flutter and Dart with Firebase backend. Deploy to iOS and Android.', duration: '2 Months', skills: ['Flutter', 'Dart', 'Firebase', 'UI Design'], instructor: '', type: 'Paid', certificate_eligible: true, status: 'active', created_at: '' },
